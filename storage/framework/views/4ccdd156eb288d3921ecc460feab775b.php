...
<div style="margin-top:70px;perspective: 1200px;display: flex;
 ...
 <div class="movie-view">
  ...
  <div class="speaker flex-center circle2">
   ...
   <?php if($seat->IsBook): ?>         
<button class="grid-item-seats" data-val='<?php echo e($seat->seat_id); ?>' data-book='yes' disabled>
...
<a href="/booked/<?php echo e($movie_id); ?>/<?php echo e($screening_id); ?>" class="float_book">
...
<?php echo $__env->make('inculdes.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\hp\Downloads\Ticket box\resources\views/book.blade.php ENDPATH**/ ?>